...
{
public:
	virtual void printImage(osg::Image* pImage) = 0;
};
...
protected:
    bool hasCullCallback( osg::Callback* nc, osg::NodeCallback* target )
    {
...
public:
    ...
    void setPrintCallback(I_PrintImage* pPI){_iprintImage = pPI;}
