...
public:
	...
	void LoadSky();
	inline nephogram_ground::CoordinateTransform* GetCoord(){return m_pCoordinateTransform;}
	inline osg::Geode* GetClipAndSurfaceGeode(){return m_pGeo;}
	//inline osg::Group* GetVolumeGroup(){return m_pVolumeNode;}
	//inline nephogram_ground::MapFactory* GetMapFactory();
	//ClipBoard* GetClipBoard(int id);
	//////////////////////////////////////////////////////////////////////////

private:
	nephogram_ground::CoordinateTransform* m_pCoordinateTransform;
	...
	osg::View* m_pView;
	osg::ref_ptr<osgEarth::SkyNode> s_sky;
