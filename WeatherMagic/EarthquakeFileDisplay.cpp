...
EarthquakeFileDisplay::EarthquakeFileDisplay(ViewerQT* pvewer) : m_pMap((nephogram_ground::Map*)pvewer->property("Map").toLongLong())
{
	m_pViewer = pvewer;
}
...
Layer* EarthquakeFileDisplay::ReadEarthquakeFileToLayer(const QString& fileName, nephogram_ground::CoordinateTransform* ct)
{
	nephogram_ground::DataProvider* pDataRovider;
	...
	nephogram_ground::Layer* pLayer = new nephogram_ground::VectorLayer(pDataRovider, ct, 1);
	///////////////////////////////////ÉèÖÃÍ¼²ãµÄ·ûºÅ¿âÊµÏÖ///////////////////////////////////////
...
void EarthquakeFileDisplay::OpenEarthquakeFile( const QString& mapConfig, const QString& fileName )
{
	...
	nephogram_ground::Layer* pEarthauakeLayer = ReadEarthquakeFileToLayer(fileName, m_pMap->GetCoordinateTransform());
	...
	//nephogram_ground::ManualDrawLayer* pLayer = new nephogram_ground::ManualDrawLayer;
	//pLayer->LayerZ(100);
...
Layer* EarthquakeFileDisplay::ReadTIFFFileToLayer( const QString& fileName, nephogram_ground::CoordinateTransform* ct )
{
	nephogram_ground::DataProvider* pDataRovider;
	typedef DataProvider* (*DataProviderPluginMain)();
...
void EarthquakeFileDisplay::OpenTIFFFile( const QString& fileName,const QString& mapConfig /*= QString()*/ )
{
	...
	nephogram_ground::Layer* pEarthauakeLayer = ReadTIFFFileToLayer(fileName, m_pMap->GetCoordinateTransform());
