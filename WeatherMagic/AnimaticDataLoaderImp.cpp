...
public:
	virtual void run()
	{
		nephogram_ground::Map* pAnimaticMap = new nephogram_ground::Map(0);
...
AnimaticControlerInterface* AnimaticDataLoaderImp::LoadAnimaticFromFileList( const QStringList& fineList )
{
	...
	nephogram_ground::Map* m_pBasicMap = m_pViewManager->GetMap2D();
	nephogram_ground::Map* pMap = (nephogram_ground::Map*)viewerWindow->property("Map").toLongLong();
	...
	*pMap =  *m_pBasicMap;
	...
	nephogram_ground::Map* _pMap = new nephogram_ground::Map(true);
