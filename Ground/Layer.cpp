...
void Layer::operator=(const Layer& other)
{
	...
	this->m_v4LayerColor = other.m_v4LayerColor;//图形颜色
	...
	this->m_pNode = other.m_pNode;//指针引用
	this->m_pParentMap = other.m_pParentMap;//指针引用
	this->m_PendingFieldMap = other.m_PendingFieldMap;
	this->m_LayerAttributeDescripe = other.m_LayerAttributeDescripe;
	//this->m_pLayerAttribteTable = other.m_pLayerAttribteTable;
	...
	this->m_pSymbolLibrary = other.m_pSymbolLibrary;//指针引用
	this->m_iUsedLegendID = other.m_iUsedLegendID;
	this->m_pParentLayer = other.m_pParentLayer;//指针引用
	this->m_pChildLayer = other.m_pChildLayer;//指针引用
