...
public:
	...
	Geometry(void);
	Geometry(geom::Geometry* geometry, CoordinateTransform* pCT, Layer* pL);
	...
	*/
	...
	/** 
	  ...
	  * @see references         
	*/
	virtual void operator=(const Geometry& other){};
	...
	inline void GetAttribute(Geometry::ATTRIBUTE_MAP* pAttribtueMap){*pAttribtueMap = m_GeometryAttribute;}*/
