...
MultiLineString::MultiLineString( geom::Geometry* geometry, CoordinateTransform* pCT /*= 0*/, Layer* pL /*= 0*/ )
...
void MultiLineString::CreateOsgFromGeos(osg::Node* pNode)
{
...
void MultiLineString::SetCoordinateTransform( CoordinateTransform* pCT )
{
	m_pCoordinateTransform = pCT;
}

void MultiLineString::TransformGeometry()
{
#if 0
	osg::Vec3 srcVec3, destVec3;
	std::size_t  fcsSize  =  m_pGeosGeomtry->getNumGeometries();
...
void MultiLineString::operator=( const MultiLineString& other )
{
...
{
	MultiLineString* pNewGeom = new MultiLineString();
	*pNewGeom = *this;
	return pNewGeom;
}
