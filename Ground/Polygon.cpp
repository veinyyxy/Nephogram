...
Polygon::Polygon( geom::Geometry* geometry, CoordinateTransform* pCT /*= 0*/, Layer* pL /*= 0*/ ) 
...
void Polygon::CreateOsgFromGeos(osg::Node* pNode)
{
...
osg::Vec3Array* Polygon::triangulizeGeometry(osg::Geometry* src)
{
...
void Polygon::SetCoordinateTransform( CoordinateTransform* pCT )
{
	m_pCoordinateTransform = pCT;
}

void Polygon::TransformGeometry()
{
	osg::Vec3 srcVec3, destVec3;
