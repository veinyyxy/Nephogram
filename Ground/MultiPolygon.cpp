...
MultiPolygon::MultiPolygon( geom::Geometry* geometry, CoordinateTransform* pCT /*= 0*/, Layer* pL /*= 0*/ )
...
void MultiPolygon::CreateOsgFromGeos(osg::Node* pNode)
{
#if 1
...
void MultiPolygon::SetCoordinateTransform( CoordinateTransform* pCT )
{
	m_pCoordinateTransform = pCT;
}

void MultiPolygon::TransformGeometry()
{
#if 0
	osg::Vec3 srcVec3, destVec3;
	std::size_t  fcsSize  =  m_pGeosGeomtry->getNumGeometries();
...
void MultiPolygon::operator=( const MultiPolygon& other )
{
...
{
	MultiPolygon* pNewGeom = new MultiPolygon();
	*pNewGeom = *this;
	return pNewGeom;
}
