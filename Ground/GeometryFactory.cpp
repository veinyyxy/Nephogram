...
GeometryFactory* GeometryFactory::g_GeometryFactory = 0;
...
{
	if(!g_GeometryFactory)
	{
		g_GeometryFactory = new GeometryFactory();
	}
	return g_GeometryFactory;
}

geos::geom::Geometry* GeometryFactory::CreateGeosGeometry( const osg::Vec3Array* value , geos::geom::GeometryTypeId geosTypeId )
{
	switch(geosTypeId)
	{
...
osg::Geometry* GeometryFactory::CreateOsgGeometryFromGeosGeomerty( const geos::geom::Geometry* pGeometry ,const osg::Vec4f& color ,  int size/*= 1*/)
{
...
osg::Geometry* GeometryFactory::CreateOsgGeometry( const osg::Vec3Array* value,const osg::Vec4f& color ,osg::PrimitiveSet::Mode psMode, int size /*= 1*/ )
{
	osg::Geometry* geometry = new osg::Geometry();
...
geos::geom::Coordinate GeometryFactory::getCoordinate(osg::Vec3f value) 
{
...
geos::geom::CoordinateSequence* GeometryFactory::getCoordinates( const osg::Vec3Array* value )
{
	int length = value->size();
...
geos::geom::Geometry* GeometryFactory::ReadWtkString(const std::string& wtk )
{
	geos::io::WKTReader wktReader;
	return wktReader.read(wtk);
}

osg::Vec3Array* GeometryFactory::GetVertexArray2GeosGemetry( const geos::geom::Geometry* geometry )
{
...
//////////////////////////////////////////////////////////////////////////
osg::Vec3Array* GeometryFactory::TriangulizeGeometry( osg::Geometry* src )
{
...
osg::Geometry* GeometryFactory::OGRGeometryToGeometry(OGRGeometry* ogrGeometry ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
...
//点
osg::Geometry* GeometryFactory::OGRPointsToGeometry(const OGRPoint* points ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
...
//多点
osg::Geometry* GeometryFactory::OGRMultiPointToGeometry(OGRMultiPoint* mpoint ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
...
//linearRing
osg::Geometry* GeometryFactory::OGRLinearRingToGeometry(OGRLinearRing* ring ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
...
//lineString
osg::Geometry* GeometryFactory::OGRLineStringToGeometry(OGRLineString* lineString ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
	osg::Geometry* contourGeom = new osg::Geometry();
	osg::Vec3Array* vertices = new osg::Vec3Array();
	OGRPoint point;
...
//多线
osg::Geometry* GeometryFactory::OGRMultiLineStringToGeometry(OGRMultiLineString* mlineString,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
	osg::Geometry* geom = new osg::Geometry;
...
//多边形
osg::Geometry* GeometryFactory::OGRPolygonToGeometry(OGRPolygon* polygon,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
	osg::Geometry* geom = new osg::Geometry();
	osg::Vec3Array* vertices = new osg::Vec3Array();
...
//多 多边形
osg::Geometry* GeometryFactory::OGRMultiPolygonToGeometry(OGRMultiPolygon* mpolygon ,CoordinateTransform* coord /*= 0*/, int z /*= 0*/, osg::Vec4f color /*= osg::Vec4f(1.0,1.0,1.0,1.0)*/ )
{
	osg::Geometry* geom = new osg::Geometry;
...
osg::Vec3Array* GeometryFactory::VertexArrayTransform(CoordinateTransform* coord , osg::Vec3Array* srcArray , int z)
{
	osg::Vec3Array* vertices = new osg::Vec3Array;
