...
public:
	...
	nephogram_ground::Map* GetCurrentMap();
...
private:
	...
	void LoadStatustoolbar(QDomNode* pDN);
	...
	QStatusBar*		m_pStatusBar;				//×´Ì¬À¸
	//StatusToolBar*	m_pStatusToolBar;			//×´Ì¬¹¤¾ßÀ¸
	//nephogram_ground::Map* Get
	//osgViewer::Viewer*
public Q_SLOTS:
